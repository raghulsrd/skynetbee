...
const arrPositionModel = isMobile ? [
  { id: 'banner', position: { x: 0, y: -0.5, z: 5 }, rotation: { x: 0, y: 1.2, z: 0 } },
  { id: 'intro', position: { x: -0.5, y: -0.8, z: -4 }, rotation: { x: 0.4, y: -0.4, z: 0 } },
  { id: 'description', position: { x: 0.2, y: -0.8, z: -2 }, rotation: { x: 0, y: 0.4, z: 0 } },
  { id: 'contact', position: { x: -0.3, y: -1.1, z: 0 }, rotation: { x: 0, y: 0, z: 0 } },
] : [
  { id: 'banner', position: { x: 0, y: -0.94, z: 0 }, rotation: { x: 0, y: 1.5, z: 0 } },
  { id: 'intro', position: { x: -1, y: -1, z: -5 }, rotation: { x: 0.5, y: -0.5, z: 0 } },
  { id: 'description', position: { x: 1.7, y: -1, z: -5 }, rotation: { x: 0, y: 0.5, z: 0 } },
  { id: 'contact', position: { x: -1.3, y: -1, z: 0 }, rotation: { x: 0, y: 0, z: 0 } },
];
...
function userReply(message) {
  ...
  setTimeout(() => {
    ...
    if (message === 'What is skynet ?') {
      botMsg.textContent = 'SkyneTBee is a tech company where we learn, build, and earn. We develop websites, apps, AI, and more.';
    } else if (message === 'What are the benifits of being in Skynet ?') {
      botMsg.textContent = 'Being in SkyneTBee means hands-on learning in real-world projects while earning. You can work in different wings like Web, Android App Development, Apple App Development, Robotics, AI, etc. Monthly salaries vary — from ₹10000 to ₹50000+ — even for students. We teach first, then pay for performance.';
  ...
  setTimeout(() => {
    ...
    const allOptions = ['What is skynet ?', 'What are the benifits of being in Skynet ?', 'Other Help'];
